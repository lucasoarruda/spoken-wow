...
L.OPT_PACK_MULTI_FMT = "%1$s. %2$d installiert; das hochwertigere wird verwendet, sofern du nichts anderes wählst."
L.OPT_PACK_SINGLE_FMT = "%1$s. Installiere ein weiteres Pack, um die Qualität zu wechseln."
...
L.OPT_LANGUAGE_TIP = "In welcher Sprache die Lore gelesen und gezeigt wird."
...
L.CMD_LANG = "  /spz lang       -- listet Sprachen, oder wechseln mit /spz lang <code>"
