...
L.OPT_PACK_MULTI_FMT = "%1$s. %2$d instalados; se usa el de mayor calidad salvo que elijas otro."
L.OPT_PACK_SINGLE_FMT = "%1$s. Instala otro paquete para cambiar de calidad."
...
L.OPT_LANGUAGE_TIP = "Idioma en que la historia se lee y se muestra."
...
L.PACK_QUALITY_HIGH = "Alta"
L.PACK_QUALITY_STANDARD = "Estándar"
...
L.CMD_LANG = "  /spz lang       -- lista idiomas, o cambia con /spz lang <code>"
