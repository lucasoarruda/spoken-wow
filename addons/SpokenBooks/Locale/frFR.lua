...
L.OPT_VOICE_LANGUAGE_TIP = "De quelle langue est le pack sonore qui vous lit. Suivre le client utilise la langue de votre jeu. Une langue ne s'entend que si un pack enregistré dedans est installé."
L.OPT_FOLLOW_CLIENT_FMT = "Suivre le client (%1$s)"
