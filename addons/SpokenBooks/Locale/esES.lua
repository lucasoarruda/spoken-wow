...
L.OPT_VOICE_LANGUAGE_TIP = "De qué idioma es el paquete de sonido que te lee. Seguir al cliente usa el idioma de tu juego. Un idioma solo se escucha si hay instalado un paquete grabado en él."
L.OPT_FOLLOW_CLIENT_FMT = "Seguir al cliente (%1$s)"
