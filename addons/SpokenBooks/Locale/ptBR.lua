...
L.OPT_VOICE_LANGUAGE_TIP = "De qual idioma é o pacote de som que lê para você. Seguir o cliente usa o idioma do seu jogo. Um idioma só é ouvido se um pacote gravado nele estiver instalado."
L.OPT_FOLLOW_CLIENT_FMT = "Seguir o cliente (%1$s)"
