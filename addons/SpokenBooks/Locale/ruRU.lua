...
L.OPT_VOICE_LANGUAGE_TIP = "Пакет на каком языке читает вам. «Как в клиенте» использует язык вашей игры. Язык слышен, только если установлен записанный на нём пакет."
L.OPT_FOLLOW_CLIENT_FMT = "Как в клиенте (%1$s)"
