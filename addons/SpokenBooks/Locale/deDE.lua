...
L.OPT_VOICE_LANGUAGE_TIP = "In welcher Sprache dich das Soundpack vorliest. „Client folgen“ nutzt die Sprache deines Spiels. Eine Sprache ist nur zu hören, wenn ein Soundpack darin aufgenommen wurde."
L.OPT_FOLLOW_CLIENT_FMT = "Client folgen (%1$s)"
