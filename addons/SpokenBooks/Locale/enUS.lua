...
L.OPT_VOICE_LANGUAGE_TIP = "Which language's sound pack reads to you. Follow Client uses the language your game runs in. A language is only heard if a sound pack recorded in it is installed."
L.OPT_FOLLOW_CLIENT_FMT = "Follow Client (%1$s)"
